...
const EtheriumTransactionsPane = ({ address }) => {
  // console.log(address.etheriumTransactions);
  if (!address.etheriumTransactions) return null
  return (
    <Table celled>
      <Table.Header>
      ...
      <Table.Body>
        {address.etheriumTransactions.map((tr, key) => (
          <Table.Row key={key}>
            <Table.Cell>
...
export default EtheriumTransactionsPane