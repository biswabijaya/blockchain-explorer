...
const BinanceTransactionsPane = ({ address }) => {
  // console.log(address.binanceTransactions);
  if (!address.binanceTransactions) return null
  return (
    <Table celled>
      <Table.Header>
      ...
      <Table.Body>
        {address.binanceTransactions.map((tr, key) => (
          <Table.Row key={key}>
            <Table.Cell>
...
export default BinanceTransactionsPane