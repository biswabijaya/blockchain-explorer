...
const BinanceBlocksPane = ({ address }) => {
  // console.log('BinanceBlocksPane-Transactions',address.binanceBlocks);
  // console.log('BinanceBlocksPane-length', Object.keys(address.binanceBlocks).length);
  var i=1;
            ...
            <Card.Content>
              <Card.Header>
                <Grid columns='four' divided>
                  <Grid.Row>
                    <Grid.Column>
                      <Grid.Row> {`Date  ${Moment((address.binanceBlocks[blockKey].transactions[0].timeStamp * 1000)).format('YYYY-MM-DD')}`} </Grid.Row>
                      <Grid.Row> <a href={"https://etherscan.io/tx/" + address.binanceBlocks[blockKey].transactions[0].hash} target="_blank"> {`Block - ${blockKey}`} </a> </Grid.Row>
                    </Grid.Column>
                    <Grid.Column>
                    ...
                    <Grid.Column>
                      <Grid.Row> {`${(address.binanceBlocks[blockKey].platform != undefined) ? address.binanceBlocks[blockKey].platform.name:""}`} </Grid.Row>
                    ...
                    <Grid.Column>
                      <Grid.Row> 
                        ...
                        {`${cumuGasFee(parseFloat(address.binanceBlocks[blockKey].gasFee))}`}
                      </Grid.Row>
                    </Grid.Column>
                  </Grid.Row>
                </Grid>
