                ...
                <Grid columns='four' divided>
                  <Grid.Row>
                    <Grid.Column style={{ wordWrap: "break-word", fontWeight: "300", fontSize: "12px" }}>
                      <Grid.Row style={{ fontWeight: "1000", fontSize: "16px", marginBottom: "5px" }}> <a href={"https://etherscan.io/tx/" + address.binanceBlocks[blockKey].transactions[0].hash} target="_blank"> {`Block - ${blockKey}`} </a> </Grid.Row>
                    ...
                    <Grid.Column>
                      <Grid.Row>
                        ...
                        {`${cumuGasFee(parseFloat(address.binanceBlocks[blockKey].gasFee))} Eth`}
                      </Grid.Row>
                    </Grid.Column>
                  </Grid.Row>
                </Grid>
